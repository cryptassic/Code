...
def main():
    ...
    # response = requests.post(url="http://google.com", data=payload, headers=headers, cookies=cookies,proxies=proxies)

    response = requests.post(
        url=oxy_config['pageurl'], data=payload, headers=headers, cookies=cookies)
